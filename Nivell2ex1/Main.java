...
//        Aquest mètode ha de rebre un String amb un número de telèfon. El mètode ha de mostrar per consola
//        un missatge dient que s’està trucant al número rebut per paràmetre.
//
//        Crea una interfície anomenada "Camera" amb el mètode fotografiar(), i una altra interfície anomenada
//        Rellotge amb el mètode alarma().
//
//        Crea una classe anomenada "Smartphone" que sigui subclasse de "Telèfon" i que a la vegada implementi
//        les interfícies "Camera" i "Rellotge".
//
